...
def nopeak_mask(size, opt):
    ...
    # Remove device specific code here since it will be handled in create_masks
    return np_mask
...
def create_masks(src, trg, cond, opt):
    ...
    if trg is not None:
        ...
        # Create nopeak mask and ensure it's on the same device as trg_mask
    ...
    # Ensure masks are on the same device as input tensors
    if src.is_cuda:
